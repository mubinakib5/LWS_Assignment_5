        ...
        <div className="p-8 flex flex-col items-center relative">
          ...
          <div className="w-full space-y-3">
            <button
              ...
              className="w-full bg-red-500 text-white py-2 px-4 rounded font-semibold text-sm hover:bg-red-600 transition-colors"
            >
              {primaryButtonText}
            </button>
            ...
            {secondaryButtonText && (
              <button
                ...
                className="w-full text-gray-600 font-semibold text-sm hover:text-gray-800 transition-colors"
              >
                {secondaryButtonText}
              </button>
            )}
